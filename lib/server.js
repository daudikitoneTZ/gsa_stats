...
const assets = [
    ...
    { route: '/global.css', filepath: '../public/global.css' }, 
    { route: '/build/bundle.css', filepath: '../public/build/bundle.css' }, 
    { route: '/build/bundle.js', filepath: '../public/build/bundle.js' }, 
    { route: '/build/bundle.js.map', filepath: '../public/build/bundle.js.map' }
];

assets.forEach(({ route, filepath }) => {
